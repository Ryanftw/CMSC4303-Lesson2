...
class _ProfileState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    userRecordOriginal ??=
        ModalRoute.of(context).settings.arguments; // ??= If the value on the left is null
    userRecord ??= UserRecord.clone(
        userRecordOriginal); // ??= Then perform the assignment userRecord = (UserRecordObject)
    return Scaffold(
      appBar: AppBar(
        title: Text("Profile"),
        actions: [
